...
class CBStateWidget {
  ...
  static final Map<int, bool> _isConnected = {
    -1: false,
    0: false,
    1: true,
    2: false,
  ...
  static bool getIsConnected(int state) {
    return _isConnected[state] ?? false;
  }
  ...
  static Map<int, bool> getIsConnectedList() {
    return _isConnected;
  }
}
